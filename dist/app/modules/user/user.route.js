...
router.get('/my-profile', (0, auth_1.default)(user_1.ENUM_USER_ROLE.GENERAL_USER), user_controller_1.UserController.getMyProfile);
router.patch('/my-profile', (0, auth_1.default)(user_1.ENUM_USER_ROLE.GENERAL_USER), (0, validateRequest_1.default)(user_validation_1.UserValidation.updateUserZodSchema), user_controller_1.UserController.updateMyProfile);
