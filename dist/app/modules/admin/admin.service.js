...
const loginUser = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const accessToken = jwtHelpers_1.jwtHelpers.createToken({ _id, role, emailAddress }, config_1.default.jwt.secret, config_1.default.jwt.expires_in);
    const refreshToken = jwtHelpers_1.jwtHelpers.createToken({ _id, role, emailAddress }, config_1.default.jwt.refresh_secret, config_1.default.jwt.refresh_expires_in);
    return {
        accessToken,
        refreshToken,
    };
...
const refreshToken = (token) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const isUserExist = yield admin_model_1.Admin.isUserExist(emailAddress);
    if (!isUserExist) {
        throw new ApiError_1.default(http_status_1.default.NOT_FOUND, 'User does not exist');
    }
    //generate new token
